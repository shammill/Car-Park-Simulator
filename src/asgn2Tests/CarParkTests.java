...
public class CarParkTests {
	...
	Car sCar2;
	 ...
	 // left // after they have // parked, without forcing them. Does not pass,
	  ...
	  @Test public void testArchiveDepartingVehicles() throws VehicleException, SimulationException 
	  ...
	  CarP.parkVehicle(car, 1, Constants.MINIMUM_STAY); CarP.parkVehicle(sCar,
	  1, Constants.MINIMUM_STAY); CarP.archiveDepartingVehicles(22, false);
	  ...
	  @Test public void testArchiveNewVehicle() throws VehicleException, SimulationException { 
	 // mot = new MotorCycle("b1", 3); 
	 // car = new Car("c1",3, false);
	  }
	  // not sure on this one, no getters for past and numdissatisfied
	  
	  @Test public void testArchiveQueueFailures() {
	  ...
	  @Test public void testCarParkEmpty() throws VehicleException, SimulationException { 
	  CarP = new CarPark(15, 5, 2, 5); 
	  mot = new MotorCycle("b1", 3); }
	  ...
	  @Test public void testCarParkFullTrue() throws VehicleException, SimulationException 
	...
	// then it will // not add it... when there // is only 1 motorcycle in there
	  ...
	  @Test public void testCarParkFullFalse() throws VehicleException, SimulationException { 
	  CarP = new CarPark(2, 1, 1, 1); mot = new
	  MotorCycle("b1", 3); 
      CarP.parkVehicle(mot, 1, 20); 
      car = new Car("c1", 3,false); 
      CarP.parkVehicle(car, 1, 20); 
	...
	//  queue? Cannot access the queue..
	  ...
	  MotorCycle("b1", 3); CarP.enterQueue(mot); assertTrue(mot.isQueued() ==
	  true);
	 ...
	 // Cannot access the queue..
	  ...
	  @Test public void testExitQueue() throws VehicleException, SimulationException { 
	CarP = new CarPark(2, 1, 1, 1); 
	mot = new MotorCycle("b1", 3); 
	CarP.enterQueue(mot); 
	...
	assertTrue(mot.isQueued() == false); }
	 ...
	 // CarPark after cars // are parked.
	  ...
	  @Test public void testGetNumCars() throws VehicleException, SimulationException {
	  CarP = new CarPark(2, 1, 1, 1); 
	  mot = new MotorCycle("b1", 3); 
	  CarP.parkVehicle(mot, 1, 20); 
	  car = new Car("c1", 3,false); 
	...
	//  the // CarPark after cars // are parked.
	  ...
	  @Test public void testGetNumCarsMotCycl() throws VehicleException, SimulationException { 
	  CarP = new CarPark(2, 1, 1, 1); 
	  mot = new MotorCycle("b1", 3); 
	  CarP.parkVehicle(mot, 1, 20); 
	  car = new Car("c1", 3,false); 
	...
	//  the // CarPark after cars // are parked.
	  ...
	  @Test public void testGetNumSmallCars() throws VehicleException, SimulationException  {
	  CarP = new CarPark(2, 1, 1, 1); 
	  mot = new MotorCycle("b1", 3); 
	  CarP.parkVehicle(mot, 1, 20); 
	  car = new Car("c1", 3,false); 
	  CarP.parkVehicle(car, 1, 20); 
	  sCar = new Car("sc1", 3, true);
	  CarP.parkVehicle(sCar, 1, 20); assertTrue(CarP.getNumSmallCars() == 1); }
	 
	  
	  // Once again here, do I get this test to print out a string and test it
	  // against the method?
	  ...
	  @Test public void testInitialState() { fail("Not yet implemented"); 
	  }
	  
	  // Here do I get the
	  
	  @Test public void testNumVehiclesInQueue() throws VehicleException, SimulationException { 
	  CarP = new CarPark(2, 1, 1, 3); 
	  mot = new MotorCycle("b1", 3); 
	  CarP.enterQueue(mot); car = new Car("c1", 3, false);
	  CarP.enterQueue(car); sCar = new Car("sc1", 3, true);
	  CarP.enterQueue(sCar); assertTrue(CarP.numVehiclesInQueue() == 3); }
	  ...
	  @Test public void testProcessQueueQueue() throws VehicleException,
	  SimulationException { CarP = new CarPark(2, 1, 1, 1); mot = new
	  MotorCycle("b1", 3); Simulator sim = new Simulator(1, 1, 1, 1, 1, 0);
	  CarP.enterQueue(mot); CarP.processQueue(4, sim);
	  ...
	  @Test public void testProcessQueuePark() throws VehicleException,
	  SimulationException { CarP = new CarPark(2, 1, 1, 1); mot = new
	  MotorCycle("b1", 3); Simulator sim = new Simulator(1, 1, 1, 1, 1, 0);
	  CarP.enterQueue(mot); CarP.processQueue(4, sim);
	  assertTrue(CarP.getNumMotorCycles() == 1);
	  ...
	  @Test public void testQueueEmptyTrue() throws VehicleException,
	  SimulationException { CarP = new CarPark(2, 1, 1, 1); mot = new
	  MotorCycle("b1", 3); CarP.enterQueue(mot); CarP.exitQueue(mot, 4);
	  assertTrue(CarP.queueEmpty() == true); }
	  
	  
	  @Test public void testQueueFull() throws VehicleException,
	  SimulationException { CarP = new CarPark(2, 1, 1, 1); mot = new
	  MotorCycle("b1", 3); CarP.enterQueue(mot); assertTrue(CarP.queueFull()==
	  true); }
	  
	  // Test to see that there is a space available for a car.
	  
	  @Test public void testSpacesAvailableCar() throws VehicleException,
	  SimulationException { CarP = new CarPark(2, 1, 1, 1); car = new Car("c1",
	  3,false); assertTrue(CarP.spacesAvailable(car) == true); }
	  
	  // Test to see that there is a space available for a car.
	 
	  @Test public void testSpacesAvailableSmallCar() throws VehicleException,
	  SimulationException { CarP = new CarPark(2, 1, 1, 1); sCar = new
	  Car("sc1", 3, true); assertTrue(CarP.spacesAvailable(sCar) == true); }
	  
	  // Test to see that there is a space available for a car.
	  
	  @Test public void testSpacesAvailableMotorCycle() throws
	  VehicleException, SimulationException { CarP = new CarPark(1, 1, 1, 1);
	  mot = new MotorCycle("b1", 3); assertTrue(CarP.spacesAvailable(mot) ==
	  true); }
	...
	// Not sure how else to test this one besides checking that carpark is not empty,
	@Test
	...
	// park by adding it to the queue. How else to test besides seeing if parkqueue is empty..? only status?
	@Test
	...
	@Test
	public void testTryProcessNewVehiclesQueueSmallCar() throws VehicleException, SimulationException {
			 CarP = new CarPark(2, 1, 1, 4); 
			 car = new Car("c1", 1, false);
			 car1 = new Car("c2", 1, false);
			 sCar = new Car("c3", 1, true);
	...
	// park by adding it to the queue.
	@Test
	public void testTryProcessNewVehiclesQueueMotorCycle() throws VehicleException, SimulationException {
			 CarP = new CarPark(2, 1, 1, 4); 
			 car = new Car("c1", 1, false);
			 car1 = new Car("c2", 1, false);
			 sCar = new Car("c3", 1, true);
	...
	public void testTryProcessNewVehiclesArchiveMotorCycle() {
	 ...
	 @Test public void testUnparkVehicle() { 
